...
public static class DependencyService
{
    ...
    public static readonly FileInfo MappingsFile = new(Path.Combine(DataFolder.FullName, Globals.LATEST_MAPPINGS));
    ...
    public static void EnsureDependencies()
    {
        TaskService.Run(() =>
        {
            EnsureResourceBased($"Assets/Mappings/{Globals.LATEST_MAPPINGS}", MappingsFile);
