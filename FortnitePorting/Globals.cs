...
public static class Globals
{
    ...
    public static readonly FPVersion Version = new(0, 4, 3, identifier: "Alpha");
    ...
    public const string LATEST_MAPPINGS = "5.3.2-3312577+++depot_marvel+S7.5_release-Marvel.usmap";
