...
public static class Globals
{
    ...
    public static readonly FPVersion Version = new(0, 4, 2, identifier: "Alpha");
    ...
    public const string LATEST_MAPPINGS = "5.3.2-3107694+++depot_marvel+S7.0_release-Marvel.usmap";
