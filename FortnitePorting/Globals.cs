...
public static class Globals
{
    ...
    public static readonly FPVersion Version = new(0, 4, 1, identifier: "Alpha");
    ...
    public const string LATEST_MAPPINGS = "5.3.2-2994263+++depot_marvel+S6.5_release-Marvel.usmap";
