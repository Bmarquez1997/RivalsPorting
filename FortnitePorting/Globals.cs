...
public static class Globals
{
    ...
    public static readonly FPVersion Version = new(0, 3, 5, identifier: "Alpha");
    ...
    public const string LATEST_MAPPINGS = "5.3.2-2189159+++depot_marvel+S3.5_release-Marvel+PY.usmap";
