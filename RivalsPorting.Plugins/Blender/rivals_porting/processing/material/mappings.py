...
class BaseFoliageMappings(MappingCollection):
    ...
    textures=(
        ...
        SlotMapping("MasksTexture"),
        SlotMapping("MaskTexture", "MasksTexture"),
        SlotMapping("Mask2DTexture", "MasksTexture"),
        SlotMapping("T_CP_Grass_Tall_01A_M", "MasksTexture"),
        SlotMapping("Normals"),
        SlotMapping("NormalMap", "Normals"),
        SlotMapping("NormalTexture", "Normals"),
...
class CroppedEmissiveMappings(MappingCollection):
    ...
    def meets_criteria(self, material_data):
        return any(get_params(material_data.get("Switches"), emissive_crop_switch_names), lambda bool: bool is True) \
            ...
            and get_param_multiple(material_data.get("Textures"), ["Emissive", "CroppedEmissive", "EmissiveCropped", "EmissiveTexture"]) is not None
...
class FurMappings(MappingCollection):
    ...
    scalars=(
        ...
        SlotMapping("Specular_POWER"),
        SlotMapping("Specular _POWER", "Specular_POWER"),
        SlotMapping("Fur_Specular_Min", "Specular_Min"),
        SlotMapping("Hair_Specular_Min", "Specular_Min"),
        SlotMapping("Fur_Specular_Max", "Specular_Max"),
        SlotMapping("Hair_Specular_Max", "Specular_Max"),
        SlotMapping("Hair_Metallic"),
        SlotMapping("Fur_Metallic", "Hair_Metallic"),
