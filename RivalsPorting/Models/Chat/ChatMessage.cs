...
public partial class ChatMessage : ObservableObject, IChatFeedItem
{
    ...
    private static readonly Bitmap ReactOn = ImageExtensions.AvaresBitmap("avares://RivalsPorting/Assets/YeahOff.png");
    private static readonly Bitmap ReactOff = ImageExtensions.AvaresBitmap("avares://RivalsPorting/Assets/YeahOn.png");

    [RelayCommand]
    public async Task React()
    {
        await Api.RivalsPorting.ReactToMessage(Id);
    }
