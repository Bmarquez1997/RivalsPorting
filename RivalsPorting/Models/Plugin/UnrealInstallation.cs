...
public partial class UnrealInstallation : ObservableObject
{
    ...
    public Bitmap Image { get; private set; } =
        ImageExtensions.AvaresBitmap("avares://RivalsPorting/Assets/UnrealLogo.png");
    ...
    [JsonIgnore]
    public string MetaPath => Path.Combine(RivalsPortingFolder, "rivals_porting_meta.json");
    ...
    public void Uninstall()
    {
        ...
        if (Directory.Exists(RivalsPortingFolder))
            Directory.Delete(RivalsPortingFolder, true);
