...
using RivalsPorting.Models.Nodes;
using RivalsPorting.Services;
using RivalsPorting.Views;

namespace RivalsPorting.WindowModels;

public abstract partial class NodeGraphPreviewWindowModelBase<TTree>(SettingsService settings) : WindowModelBase
    where TTree : NodeTree, new()
{
    [ObservableProperty] private SettingsService _settings = settings;

    [ObservableProperty] private ObservableCollection<TTree> _trees = [];
    [ObservableProperty] private TTree? _selectedTree;
    ...
    public void Load(TTree nodeTree)
    {
